...
extension SubscriptionByIndex on IsarCollection<Subscription> {
  ...
  List<Id> putAllByUserIdSync(List<Subscription> objects,
      {bool saveLinks = true}) {
